 ...
 */
static CK_RV set_custom_attrs_from_string(char *attr_char, CK_ATTRIBUTE *attr, CK_ULONG *count) 
{
    CK_RV rc = CKR_OK;
    int i = 0, j = 0;
    char substr[10];
 ...
 * List the given key.
 */
static CK_RV list_ckey(CK_SESSION_HANDLE session, p11sak_kt kt, int long_print, char *label)
{
